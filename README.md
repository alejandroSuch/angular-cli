...
```
docker run -it --rm -w /app -v $(pwd):/app alexsuch/angular-cli:1.6.8-chromium ng new my-project-name
```

### Generating a component

```
docker run -it --rm -w /app -v $(pwd)/my-project-name:/app alexsuch/angular-cli:1.6.8-chromium ng g component sample-component
```

### Serving

```
docker run -it --rm -w /app -v $(pwd)/my-project-name:/app -p 4200:4200 alexsuch/angular-cli:1.6.8-chromium ng serve --host 0.0.0.0
```
