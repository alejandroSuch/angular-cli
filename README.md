...
```
docker run -it --rm -w /app -v $(pwd):/app alexsuch/angular-cli:1.4.0-beta.2 ng new my-project-name
```

### Generating a component

```
docker run -it --rm -w /app -v $(pwd)/my-project-name:/app alexsuch/angular-cli:1.4.0-beta.2 ng g component sample-component
```

### Serving

```
docker run -it --rm -w /app -v $(pwd)/my-project-name:/app -p 4200:4200 alexsuch/angular-cli:1.4.0-beta.2 ng serve --host 0.0.0.0
```
